...
function bootstrap_breadcrumb()
{
    ...
    $html = '<ol class="breadcrumb" id="main-breadcrumb" style="background: transparent">';

    if ((is_front_page()) || (is_home())) {
        $html .= '<li class="breadcrumb-item active">' . __('Home', 'otherways') . '</li>';
    }

    else {
        $html .= '<li class="breadcrumb-item"><a href="' . esc_url(home_url('/')) . '">' . __('Home', 'otherways') . '</a></li>';
        ...
        elseif (is_category()) {
            ...
            $html .= '<li class="breadcrumb-item active">' . __('Pencarian Untuk', 'otherways') . '</li>';
            $html .= '<li class="breadcrumb-item active">' . get_search_query() . '</li>';
        } elseif (is_404()) {
            $html .= '<li class="breadcrumb-item active">' . __('Galat Permintaan', 'otherways') . '</li>';
            $html .= '<li class="breadcrumb-item active">' . __('Kode 404', 'otherways') . '</li>';
        }
